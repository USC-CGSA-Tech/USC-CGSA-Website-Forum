...
$lang = array (
  ...
  'loginname' => '登录名',
  'memcp_profile_loginname_comment' => '设置单独的登录名，设置后将无法使用“UID、E-mail、用户名”的方式登录，使帐号更安全',
  ...
  'video_auth_message_1' => '以下是您认证的视频照片。如果站长允许重复认证，您可以<a href="home.php?mod=spacecp&ac=videophoto">重新进入视频认证程序 ',
