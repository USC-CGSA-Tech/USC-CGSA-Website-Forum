...
EOT;
    ...
    $ec_wxpay_key = $settings['ec_wxpay_key'] ? $settings['ec_wxpay_key']{0}.'********'.substr($settings['ec_wxpay_key'], -4) : '';//API密钥
	...
	if(!submitcheck('ordersubmit')) {
		...
		$ordercount = C::t('forum_order')->count_by_search(0, $_GET['orderstatus'], $_GET['orderid'], $_GET['email'], null, $buyer);
