...
function getranklistdata($type, $view = '', $orderby = 'all') {
	...
	(!isset($_G['cache']['ranklist_'.$type]) || !is_array($_G['cache']['ranklist_'.$type])) && $_G['cache']['ranklist_'.$type] = array();
	(!isset($_G['cache']['ranklist_'.$type][$view]) || !is_array($_G['cache']['ranklist_'.$type][$view])) && $_G['cache']['ranklist_'.$type][$view] = array();
	(!isset($_G['cache']['ranklist_'.$type][$view][$orderby]) || !is_array($_G['cache']['ranklist_'.$type][$view][$orderby])) && $_G['cache']['ranklist_'.$type][$view][$orderby] = array();
